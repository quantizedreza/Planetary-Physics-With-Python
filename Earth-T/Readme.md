...
35+ years of continuous measurements. Systemic errors associated with these measurements are errors caused by califbration, heat radiation from nearby sources and other factors which might affect the error. That number, is not considered here. Only statistical uncertainties and noises are studied here.
